...
function Cart() {
    ...
    me.blogCheckout = function() {
        var form = document.createElement("form"),
            counter = 1,
            current, item, descriptionString;
        form.style.display = "none";
        form.method = me.blogHTTPMethod == "GET" || me.blogHTTPMethod == "POST" ? me.blogHTTPMethod : "GET";
        form.action = me.sandbox ? "http://tokonaanakkudua.blogspot.com" : "https://tokonaanakkudua.blogspot.com/p/halaman-cekout.html";
        form.acceptCharset = "utf-8";
        form.appendChild(me.createHiddenElement("cmd", "_cart"));
        form.appendChild(me.createHiddenElement("rm", me.blogHTTPMethod == "POST" ? "2" : "0"));
    ...
    me.currencyStringForBlogCheckout = function(value) {
    ...
    if (document.getElementsByClassName) {
        ...
        getElementsByClassName = function(className, tag, elm) {
            ...
            for (var k = 0, kl = classes.length; k < kl; k += 1) {
                classesToCheck.push(new RegExp("(^|\\s)" + classes[k] + "(\\s|Rp&nbsp)"));
            }
